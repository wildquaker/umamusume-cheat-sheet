    ...
    <PageLayout title="Welcome">
      <div className="space-y-8">
        <div className="rounded-xl overflow-hidden border border-neutral-800 shadow-2xl relative">
          <Image
            src="/images/home_art.webp"
            alt="Umamusume Home Art"
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
            ...
            <p className="text-neutral-300 max-w-2xl">
              Everything you need to raise champion Uma Musume - from skill
              recommendations to support card builds.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link
              href="/characters"
              className="group flex items-center gap-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800 hover:border-pink-500/50 hover:bg-neutral-800/50 transition-all"
            >
            ...
            <Link
              href="/skills"
              className="group flex items-center gap-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800 hover:border-blue-500/50 hover:bg-neutral-800/50 transition-all"
            >
            ...
            <Link
              href="/builds"
              className="group flex items-center gap-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800 hover:border-green-500/50 hover:bg-neutral-800/50 transition-all"
            >
            ...
            <Link
              href="/races"
              className="group flex items-center gap-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800 hover:border-yellow-500/50 hover:bg-neutral-800/50 transition-all"
            >
            ...
            <Link
              href="/links"
              className="group flex items-center gap-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800 hover:border-purple-500/50 hover:bg-neutral-800/50 transition-all"
            >
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400 leading-relaxed">
                This cheat sheet is designed to help trainers quickly find the
                information they need for raising Uma Musume. Data is based on
                the Global version and community research. Use the navigation on
                the left to explore different sections.
              </p>
            </div>
          </div>
        </div>
