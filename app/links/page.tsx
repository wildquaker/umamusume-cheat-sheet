    ...
    <PageLayout title="Links">
      <div className="space-y-6">
        <div className="prose prose-invert max-w-none">
          <p className="text-neutral-400">Useful external resources for guides, tier lists, and tools.</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {links.map((link: any, index: number) => (
            ...
            >
              <span className="font-medium text-neutral-200 group-hover:text-white transition-colors">{link.text}</span>
